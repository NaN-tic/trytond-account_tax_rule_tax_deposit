...
setup(name='%s_%s' % (PREFIX, MODULE),
    ...
    url='https://github.com/NaN-tic/trytond-account_tax_rule_tax_deposit',
    download_url='https://github.com:nantic/trytond-account_tax_rule_tax_deposit.git',
    ...
    project_urls = {
       "Source Code": 'https://github.com:NaN-tic/trytond-account_tax_rule_tax_deposit.git'
    },
    classifiers=[
